...
const sketch = function (p) {
  ...
  const lineColor = p.color(0, 0, 100);
  ...
  const clearScreen = function () {
    ...
    hallucinationGraphics.background(0, 0, 0, 100);
      ...
      .then((data) => {
        ...
        if (lastHallucinationStartPoint) {
          ...
          const drawingLengthSinceLastHallucination = lastMouseState.down
            ...
            : 10;
            hallucinationGraphics.background(0, 0, 0, p.lerp(10, 90, drawingLengthSinceLastHallucination / 30));
        }
